...
- exact error text with private content removed;
- steps that reproduce the problem.

Questions about billing, quotas, account access, model availability, retention or training policy belong to the selected provider.
