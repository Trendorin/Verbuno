...
| Ausgabe | Inkrementelle SSE-Ausgabe mit begrenzter Wartezeit auf den ersten Token und weitere Daten; eine hängende kostenlose Route wird einmal automatisch wiederholt. |
