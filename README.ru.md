...
TranslUnix — нативный Linux-клиент для перевода на C++20 и Qt 6 Widgets. Он открывается компактным popup из трея, потоково получает перевод от OpenRouter или другого OpenAI-совместимого API и оставляет выбор провайдера, модели и локального хранения под контролем пользователя.

## Возможности

| Раздел | Результат |
|---|---|
| Быстрый доступ | Лёгкий popup из трея; в полном окне доступны контекст, история и настройки. |
