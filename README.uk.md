...
TranslUnix — нативний Linux-клієнт перекладу на C++20 і Qt 6 Widgets. Трей відкриває звичайне системне вікно з рамкою та зміною розміру, відповідь OpenRouter або іншого OpenAI-сумісного API надходить потоком, а активні провайдер і модель завжди видимі.
