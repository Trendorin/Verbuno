<p align="center">
  <img src="data/icons/hicolor/scalable/apps/io.github.trendorin.TranslUnix.svg" width="144" alt="Піктограма TranslUnix">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/Trendorin/TranslUnix/releases/latest"><img alt="Реліз" src="https://img.shields.io/github/v/release/Trendorin/TranslUnix?style=flat-square&label=release&labelColor=15181b&color=5d666d"></a>
...
<p align="center">
  ...
  <a href="https://github.com/Trendorin/TranslUnix/releases">Релізи</a>
</p>

TranslUnix — нативний Linux-клієнт перекладу на C++20 і Qt 6 Widgets. Компактне вікно відкривається з трея, відповідь OpenRouter або іншого OpenAI-сумісного API надходить потоком, а вибір провайдера, моделі та локального зберігання залишається за користувачем.

## Можливості

| Розділ | Результат |
|---|---|
| Швидкий доступ | Легкий popup із трея; повне вікно додає контекст, історію й налаштування. |
...
| Провайдери | OpenRouter типово та довільний OpenAI-сумісний Chat Completions endpoint. |
| Відповідь | Потоковий SSE-вивід, скасування запиту та зрозумілі помилки. |

## Межі приватності

| TranslUnix робить | TranslUnix не може гарантувати |
|---|---|
...
Завантажте відповідний пакет і `SHA256SUMS` з [останнього релізу](https://github.com/Trendorin/TranslUnix/releases/latest).
...
- Глобальна клавіша — прив’яжіть `translunix --toggle` у налаштуваннях KDE/GNOME.
